...
javascript:(function(){
    ...
    listTitle.textContent = 'Select & Reorder Engines:';
    ...
    Object.assign(engineList.style, {
      maxHeight: '180px',
      overflowY: 'auto',
      marginBottom: '15px'
    });
    ...
    function renderEngines() {
      ...
      engines.forEach((eng, index) => {
        ...
        Object.assign(downBtn.style, {
          ...
          padding: '2px 5px',
          borderRadius: '4px',
          cursor: index === engines.length - 1 ? 'default' : 'pointer',
          fontSize: '9px',
          opacity: index === engines.length - 1 ? '0.4' : '1'
        });
        downBtn.disabled = index === engines.length - 1;
        downBtn.onclick = () => {
    ...
    Object.assign(addEngineArea.style, {
    ...
    resetPrefsBtn.textContent = 'Reset';
    ...
    resetPrefsBtn.onclick = () => {
      if (confirm('Are you sure you want to reset all engines and preferences to default?')) {
    ...
    footer.appendChild(resetPrefsBtn);
